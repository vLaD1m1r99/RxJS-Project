...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/dist/esm5/internal/observable/from.js");
...
class Game {
    ...
    youWon;
    canvas;
    constructor(canvas, imageAssets) {
    ...
    createPlayer(canvas, characterAssets) {
        ...
        }, canvas, characterAssets.characterStandLeft, characterAssets.characterStandRight, characterAssets.characterMoveLeft, characterAssets.characterMoveRight);
    }
    createPlatforms(canvas, platformImage) {
        ...
        while (_utils__WEBPACK_IMPORTED_MODULE_8__.winingLength > lastX - maxGap) {
    ...
    createFinishLine(finishImage) {
        ...
        this.finish = new _finish__WEBPACK_IMPORTED_MODULE_5__.Finish({
            x: _utils__WEBPACK_IMPORTED_MODULE_8__.winingLength - this.scrollOffset + 400,
    ...
    gameMovement() {
        const keydown$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.fromEvent)(document, 'keydown').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.filter)((event) => {
            return (event.code === 'KeyA' ||
                event.code === 'KeyD' ||
                event.code === 'Space');
        }));
        const keyup$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.fromEvent)(document, 'keyup').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.filter)((event) => {
            return (event.code === 'KeyA' ||
                event.code === 'KeyD' ||
                event.code === 'Space');
        }));
        (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.merge)(keydown$, keyup$).subscribe((event) => {
            if (this.player) {
    ...
    checkForColision() {
        (0,rxjs__WEBPACK_IMPORTED_MODULE_12__.from)(this.platforms)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.filter)((platform) => this.player.position.y + this.player.size.height <=
            platform.position.y &&
    ...
    checkMovement() {
        if (this.keys.right.pressed && this.player.position.x < 400)
            ...
            if (this.keys.right.pressed) {
                this.scrollOffset += _utils__WEBPACK_IMPORTED_MODULE_8__.playerSpeed;
                this.platforms.forEach((platform) => {
                    platform.position.x -= _utils__WEBPACK_IMPORTED_MODULE_8__.platformSpeed;
                });
                this.genericObjects.forEach((genericObject) => {
                    genericObject.position.x -= _utils__WEBPACK_IMPORTED_MODULE_8__.genericObjectSpeed;
                });
            }
    ...
    gameStatus() {
        // Win condition
        if (this.scrollOffset > _utils__WEBPACK_IMPORTED_MODULE_8__.winingLength) {
...
class Player {
    ...
    currentSprite;
    canJump;
    constructor(position, velocity, size, canvas, imgStandLeft, imgStandRight, imgRunLeft, imgRunRight) {
        this.position = position;
    ...
    update() {
        ...
        if (this.position.y + this.size.height + this.velocity.y <=
            this.canvas.height)
            this.velocity.y += _utils__WEBPACK_IMPORTED_MODULE_0__.gravity;
        this.draw(this.canvas.getContext('2d'));
    }
    moveLeft() {
        this.velocity.x = -_utils__WEBPACK_IMPORTED_MODULE_0__.playerSpeed;
    }
    moveRight() {
        this.velocity.x = +_utils__WEBPACK_IMPORTED_MODULE_0__.playerSpeed;
    }
    ...
    jump() {
        if (this.canJump === true)
            this.velocity.y = -_utils__WEBPACK_IMPORTED_MODULE_0__.playerJump;
    }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "createGap": () => (/* binding */ createGap),
/* harmony export */   "createImage": () => (/* binding */ createImage),
/* harmony export */   "genericObjectSpeed": () => (/* binding */ genericObjectSpeed),
/* harmony export */   "gravity": () => (/* binding */ gravity),
/* harmony export */   "loadImages": () => (/* binding */ loadImages),
/* harmony export */   "platformSpeed": () => (/* binding */ platformSpeed),
/* harmony export */   "playerJump": () => (/* binding */ playerJump),
/* harmony export */   "playerSpeed": () => (/* binding */ playerSpeed),
/* harmony export */   "winingLength": () => (/* binding */ winingLength)
/* harmony export */ });
const gravity = 0.5;
const playerSpeed = 5;
const playerJump = 15;
const platformSpeed = 5;
const genericObjectSpeed = 3;
const winingLength = 10000;
...
async function initializeAndStartGame() {
    ...
    if (gameAssets && imageAssets) {
        ...
        const game = new _game__WEBPACK_IMPORTED_MODULE_0__.Game(canvas, loadedImageAssets);
        game.start();
    }
    else {
