...
/* harmony import */ var _genericObject__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./genericObject */ "./src/genericObject.ts");
...
const platformImage = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.createImage)('./img/platform.png');
const backgroundImage = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.createImage)('./img/bg.png');
const finishImage = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.createImage)('./img/finish.png');
const charRunLeftImage = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.createImage)('./img/charMoveLeft.png');
const charRunRightImage = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.createImage)('./img/charMoveRight.png');
const charStandLeftImage = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.createImage)('./img/charStandLeft.png');
const charStandRightImage = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.createImage)('./img/charStandRight.png');
class Game {
    ctx;
    player;
    platforms;
    ...
    createPlayer(canvas) {
        this.player = new _player__WEBPACK_IMPORTED_MODULE_0__.Player({ x: 50, y: 50 }, { x: 0, y: 0 }, {
            width: charStandRightImage.width,
            height: charStandRightImage.height,
        }, canvas, charStandLeftImage, charStandRightImage, charRunLeftImage, charRunRightImage);
    }
    createPlatforms(canvas) {
        this.platforms = [];
        // Creating first platfom
        this.platforms.push(new _platform__WEBPACK_IMPORTED_MODULE_1__.Platform({ x: 0, y: 700 }, { width: platformImage.width, height: platformImage.height }, platformImage));
        // Gap constants
        const minGap = 100;
        const maxGap = 300;
        let lastX = platformImage.width;
        // Creating all other random platforms
        while (_utils__WEBPACK_IMPORTED_MODULE_3__.winingLength > lastX - maxGap) {
            ...
            this.platforms.push(new _platform__WEBPACK_IMPORTED_MODULE_1__.Platform({ x, y }, { width: platformImage.width, height: platformImage.height }, platformImage));
        }
    }
    createGenericObjects(canvas) {
        this.genericObjects = [];
        for (let i = 0; i < 10; i++) {
            this.genericObjects.push(new _genericObject__WEBPACK_IMPORTED_MODULE_2__.GenericObject({ x: backgroundImage.width * i, y: 0 }, {
    ...
    drawFinishLine() {
        ...
        this.ctx.drawImage(finishImage, _utils__WEBPACK_IMPORTED_MODULE_3__.winingLength - this.scrollOffset + 400, lastPlatform.position.y - finishImage.height, finishImage.width, finishImage.height);
    }
    gameMovement() {
        const keydown$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(document, 'keydown').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.filter)((event) => {
            return (event.code === 'KeyA' ||
                event.code === 'KeyD' ||
                event.code === 'Space');
        }));
        const keyup$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(document, 'keyup').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.filter)((event) => {
            return (event.code === 'KeyA' ||
                event.code === 'KeyD' ||
                event.code === 'Space');
        }));
        (0,rxjs__WEBPACK_IMPORTED_MODULE_6__.merge)(keydown$, keyup$).subscribe((event) => {
            if (this.player) {
    ...
    checkForColision() {
        (0,rxjs__WEBPACK_IMPORTED_MODULE_7__.from)(this.platforms)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.filter)((platform) => this.player.position.y + this.player.size.height <=
            platform.position.y &&
    ...
    checkMovement() {
        if (this.keys.right.pressed && this.player.position.x < 400)
            ...
            if (this.keys.right.pressed) {
                this.scrollOffset += _utils__WEBPACK_IMPORTED_MODULE_3__.playerSpeed;
                this.platforms.forEach((platform) => {
                    platform.position.x -= _utils__WEBPACK_IMPORTED_MODULE_3__.platformSpeed;
                });
                this.genericObjects.forEach((genericObject) => {
                    genericObject.position.x -= _utils__WEBPACK_IMPORTED_MODULE_3__.genericObjectSpeed;
                });
            }
    ...
    gameStatus() {
        // Win condition
        if (this.scrollOffset > _utils__WEBPACK_IMPORTED_MODULE_3__.winingLength)
            console.log('you win');
